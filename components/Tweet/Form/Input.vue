<template>
  <div>
    ...
    <div class="flex p-2 pl-14">
      ...
      <div class="ml-auto">
        <UIButton size="sm" :disabled="isDisabled" @on-click="handleClick">
          <strong>
            Tweet
          </strong>
        </UIButton>
...
<script setup>
const text = ref('');
const imageFileSelectRef = ref(null);
...
const handleClick = () => {
  ...
  console.log('onsubmit event emiited', text.value)
  text.value = '';
}
...
const handleImageClick = () => {
  imageFileSelectRef.value.click();
}
